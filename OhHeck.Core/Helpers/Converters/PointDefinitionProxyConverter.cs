...
public class PointDefinitionProxyConverter : JsonConverter<PointDefinitionDataProxy>
{
	...
	public override void Write(Utf8JsonWriter writer, PointDefinitionDataProxy value, JsonSerializerOptions options) => JsonSerializer.Serialize(writer, value.PointDefinitionData, options);
