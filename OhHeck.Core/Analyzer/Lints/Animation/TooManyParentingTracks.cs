...
public class TooManyParentingTracks : IFieldAnalyzer
{
	...
	public void Validate(Type fieldType, object? value, IWarningOutput outerWarningOutput)
	{
		...
		{
			outerWarningOutput.WriteWarning($"Excessive amounts of parent track events. Parenting is inefficient, consider using less. Found {parentTrackCount} > {TRACK_PARENTING_EXCESS}");
		}
	}
}